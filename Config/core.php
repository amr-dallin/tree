 ...
 */
	Configure::write('Session', array(
		'defaults' => 'php',
        'timeout' => 14400, // 36 hours
        'ini' => array(
            'session.gc_maxlifetime' => 864000 // 36 hours
        )
	));

/**
 * A random string used in security hashing methods.
 */	Configure::write('Security.salt', 'b77b5126352dbf26a739172f4df356108e08db2f');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */	Configure::write('Security.cipherSeed', '313533303630373838323730383865');
